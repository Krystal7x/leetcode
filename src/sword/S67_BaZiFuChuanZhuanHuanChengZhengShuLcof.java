...
public class S67_BaZiFuChuanZhuanHuanChengZhengShuLcof {
    ...
    class Solution {
        public int strToInt(String str) {
            ...
            for (int j = i; j < c.length; j++) {
                ...
                //这一位大于7
                if (res > max || res == max && c[j] > '7') return sign == 1 ? Integer.MAX_VALUE : Integer.MIN_VALUE;
                res = res * 10 + (c[j] - '0');
            }
            return sign * res;
        }
...
//leetcode submit region end(Prohibit modification and deletion)
    ...
    public static void main(String[] args) {
        Solution solution = new S67_BaZiFuChuanZhuanHuanChengZhengShuLcof().new Solution();
